...
func DefaultEthereumServiceProvider(wrapped interface{}) *ServerProviderService {
	return &ServerProviderService{
		ServiceCallbacks:           DefaultSuitableCallbacksEthereum(wrapped),
		ServiceCallbackToMethod:    DefaultCallbackToMethodEthereum,
...
// DefaultCallbackToMethodEthereum will parse a method to an openrpc method.
...
func DefaultCallbackToMethodEthereum(opts *DocumentProviderParseOpts, name string, cb Callback) (*goopenrpcT.Method, error) {
